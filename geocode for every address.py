...
input_csv = "chinese_restaurant_la.csv"  # Path to the input CSV file containing addresses
output_csv = "chinese_restaurant_la_geocode.csv"  # Path to the output CSV file
